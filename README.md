# dash-components-material

Dash components with material-ui theme.
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-components-material -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-components-material to your layout, then run it:
